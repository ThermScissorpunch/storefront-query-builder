...
function getConfig(config, queryText) {
    var scoringConfig = config.elasticsearch.hasOwnProperty('searchScoring') ? config.elasticsearch.searchScoring : {};
    var minimumShouldMatch = scoringConfig.hasOwnProperty('minimum_should_match') ? scoringConfig.minimum_should_match : '75%';
...
function getMultiMatchConfig(config, queryText) {
    return getConfig(config, queryText);
}
exports.default = getMultiMatchConfig;
//# sourceMappingURL=multimatch.js.map